...
//main elements
ctaLoad.from(".quote-cta_component", {y: 200, scale: 0.9, duration: .875, ease:"power4.out"})
ctaLoad.fromTo(".quote-cta_heading-wrapper", {opacity: 0, scale: 0, y: 400}, {opacity: 1, scale: 1, y: 100, duration: .75, ease: "power4.out"}, "<+0.125");
...
ctaLoad.from(".quote-cta_subheading", {y:150, duration: 0.875, ease: "power2.out", opacity: 0}, ">");
