...
const loadScriptsForSections = ()=>{
    scriptsMap.forEach((scriptInfo, selector)=>{
        ...
        if (element) preloadAndExecuteScript(scriptInfo.src, scriptInfo.id);
    });
};
...
window.Animations = {
    ...
    animateSolutions () {
        ...
        solutionsLoad.from(".solutions_service-card > .solutions_service-icon-wrapper > .solutions_service-icon", {
            y: 50,
            opacity: 0,
            stagger: "0.125"
        }, 0.25);
    ...
    animateTechStack () {
        ...
        csTechStack.from(".tech-stack_subheading-wrapper > p", {
            y: 50,
            opacity: 0
        }, 0.25);
...
},{}]},["4pF1N","bNKaB"], "bNKaB", "parcelRequire41e5", {})
