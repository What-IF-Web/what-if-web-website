...
const $298ad17b2ba72143$var$url = window.location.pathname;
// Define mappings for scripts based on DOM selectors
const $298ad17b2ba72143$var$scriptsMap = new Map([
    [
        ".section_home-header",
        {
...
const $298ad17b2ba72143$var$urlScriptsMap = new Map([
    [
        "pricing",
        {
...
function $298ad17b2ba72143$var$preloadAndExecuteScript(src, id) {
...
$298ad17b2ba72143$var$scriptsMap.forEach((scriptInfo, selector)=>{
    if (scriptInfo && scriptInfo.src && scriptInfo.id) {
        if (document.querySelector(selector)) $298ad17b2ba72143$var$preloadAndExecuteScript(scriptInfo.src, scriptInfo.id);
    }
});
// Load scripts based on URL matching
$298ad17b2ba72143$var$urlScriptsMap.forEach(({ src: src, id: id }, key)=>{
    if ($298ad17b2ba72143$var$url.includes(key)) $298ad17b2ba72143$var$preloadAndExecuteScript(src, id);
});
...
const $298ad17b2ba72143$var$variantField = document.querySelector(".wf-variant-dropdown");
if ($298ad17b2ba72143$var$variantField?.value === "White") {
...
const $298ad17b2ba72143$var$confettiEffect = ()=>{
    setTimeout(()=>{
        try {
            confetti({
                particleCount: 150,
...
document.querySelectorAll("#email-form, #footer-form").forEach((form)=>{
    form.addEventListener("submit", $298ad17b2ba72143$var$confettiEffect);
});
// Navbar toggle
...
const $298ad17b2ba72143$var$resourcesObserver = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.isIntersecting) {
            ...
            $298ad17b2ba72143$var$resourcesObserver.unobserve(entry.target);
        }
    });
}, {
    threshold: 0.5
});
const $298ad17b2ba72143$var$resourcesSection = document.querySelector(".section_resources");
if ($298ad17b2ba72143$var$resourcesSection) $298ad17b2ba72143$var$resourcesObserver.observe($298ad17b2ba72143$var$resourcesSection);
// Animations object
window.Animations = {
    animateFooter () {
