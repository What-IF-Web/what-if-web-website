...
})({"aOmXC":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "565c21bcab862524";
"use strict";
...
},{}],"cQTi2":[function(require,module,exports,__globalThis) {
//Pricing stuff
...
var pricingLoad = gsap.timeline({
    scrollTrigger: {
        trigger: ".section_pricing"
    }
});
pricingLoad.from(".pricing_content-top > h1, .pricing_content-top > .pricing_paragraph-wrapper", {
    y: 80,
    opacity: 0,
    duration: 0.875,
    ease: "power3.out",
...
pricingLoad.from(".pricing_card.is-left", {
    y: 200,
    opacity: 0,
    scale: 0.9,
    rotateZ: -15,
...
pricingLoad.from(".pricing_card.is-centre", {
    y: 200,
    opacity: 0,
    scale: 0.9,
    duration: 1,
...
pricingLoad.from(".pricing_card.is-right", {
    y: 200,
    opacity: 0,
    scale: 0.9,
    rotateZ: 15,
...
},{}]},["aOmXC"], null, "parcelRequire94c2")

//# sourceMappingURL=pricing.ab862524.js.map
